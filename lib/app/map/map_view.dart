...
class _MapPageView extends View<MapPage> {
  ...
  StaticMapProvider _staticMapProvider = StaticMapProvider(googleApiKey);
  Uri staticMapUri;
 ...
 @override
  initState() {
    ...
    staticMapUri = _staticMapProvider.getStaticUri(Locations.portland, 12,
  ...
  _handleDismiss() async {
    ...
    var uri = await _staticMapProvider.getImageUriFromMap(mapView,
